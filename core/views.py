...
def landing_view(request):
    ...
    context = {
        "school_name": getattr(settings, "SCHOOL_NAME", "Centennial Christian Seminary"),
        "school_motto": getattr(settings, "SCHOOL_MOTTO", "A New Generation Leader"),
        "school_vision": getattr(settings, "SCHOOL_VISION", "High Quality Education In a Nurturing Environment"),
        "school_phone": getattr(settings, "SCHOOL_PHONE", "07 87 199 099"),
        "school_email": getattr(settings, "SCHOOL_EMAIL", "info@ccstz.org"),
        "school_address": getattr(settings, "SCHOOL_ADDRESS", "Kongowe-Mkuranga, Coast Region, Tanzania"),
        "school_facebook": getattr(settings, "SCHOOL_FACEBOOK", "https://facebook.com/CCSTZN/"),
        "school_instagram": getattr(settings, "SCHOOL_INSTAGRAM", "https://instagram.com/ccstzn"),
    }
